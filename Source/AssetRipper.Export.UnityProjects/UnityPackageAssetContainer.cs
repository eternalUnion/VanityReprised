...
{
	internal class UnityPackageAssetContainer : IExportContainer
	{
		public UnityPackageAssetContainer(UnityPackageExporter exporter, CoreConfiguration options, IEnumerable<IUnityObjectBase> assets,
			IReadOnlyList<IExportCollection> collections)
		{
			...
			[Conditional("DEBUG")]
			static void CheckIfAlreadyAdded(UnityPackageAssetContainer container, IUnityObjectBase asset, IExportCollection currentCollection)
			{
		...
		private readonly UnityPackageExporter m_exporter;
